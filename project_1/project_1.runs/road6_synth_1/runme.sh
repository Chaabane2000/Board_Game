...
HD_PWD='/home/mankaic/Desktop/project_1/project_1.runs/road6_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log road6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source road6.tcl
