...
HD_PWD='/home/mankaic/Desktop/project_1/project_1.runs/road1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log road1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source road1.tcl
