...
HD_PWD='/home/mankaic/Desktop/project_1/project_1.runs/road3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log road3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source road3.tcl
