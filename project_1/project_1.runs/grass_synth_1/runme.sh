...
HD_PWD='/home/mankaic/Desktop/project_1/project_1.runs/grass_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log grass.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source grass.tcl
