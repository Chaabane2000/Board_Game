...
HD_PWD='/home/mankaic/Desktop/project_1/project_1.runs/green_car_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log green_car.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source green_car.tcl
