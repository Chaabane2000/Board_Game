...
HD_PWD='/home/mankaic/Desktop/project_1/project_1.runs/road8_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log road8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source road8.tcl
