...
#
# Generated by export_simulation on Fri Oct 17 02:16:18 +03 2025
#
################################################################################
...
'-reset_run' switch to the './road9.sh' script.
...
./road9.sh -noclean_files

For more information on the script, please type './road9.sh -help'.
