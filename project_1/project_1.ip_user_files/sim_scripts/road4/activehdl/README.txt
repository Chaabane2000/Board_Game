...
#
# Generated by export_simulation on Thu Oct 09 19:55:00 +03 2025
#
################################################################################
...
'-reset_run' switch to the './road4.sh' script.
...
./road4.sh -noclean_files

For more information on the script, please type './road4.sh -help'.
