...
#
# Generated by export_simulation on Fri Oct 17 01:46:00 +03 2025
#
################################################################################
...
'-reset_run' switch to the './road7.sh' script.
...
./road7.sh -noclean_files

For more information on the script, please type './road7.sh -help'.
